    ...
    <el-card shadow="never" style="margin-top: 15px">
      ...
      <div class="table-layout">
        ...
        <el-row>
          ...
          <el-col :span="6" class="table-cell">
            <span class="color-danger">￥{{order.totalAmount + order.freightAmount - order.discountAmount - order.promotionAmount - order.couponAmount - order.integrationAmount}}</span>
          </el-col>
        </el-row>
      </div>
      <div style="margin-top: 20px">
