...
public class MyBatisPlusGeneratorTest {
    ...
    public void generate(){
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/zrrd_mall?serverTimezone=UTC&useUnicode=true&characterEncoding=utf-8&useSSL=true", "root", "root")
                .globalConfig(builder -> {
                    builder.author("Ming") // 设置作者
                            .enableSwagger() // 开启 swagger 模式
                            .fileOverride() // 覆盖已生成文件
                            .outputDir("D://中软云创商城项目"); // 指定输出目录
                })
                .packageConfig(builder -> {
                    builder.parent("com.zrrd.shop") // 设置父包名
                            .moduleName("ums") // 设置父包模块名
                            .pathInfo(Collections.singletonMap(OutputFile.xml, "D://中软云创商城项目/mapper/")); // 设置mapperXml生成路径
                })
